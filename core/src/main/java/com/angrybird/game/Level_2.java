...
public class Level_2 implements Screen {
    ...
    public Level_2(Game game, Screen previousScreen) {
        this.game = game;
...
// Create an array of texture paths for the birds
        ...
        Pig smallPig1 = new Pig("small_pig.png", false, new Vector2(12.10f,-14.5f),10,"small",500);
        ...
        Pig smallPig4 = new Pig("small_pig.png", false, new Vector2(21.30f,-7f),10,"small",500);

        Pig mediumPig1 = new Pig("medium_pig.png", false, new Vector2(14.10f,-1),20,"medium",1000);
...
//                MaterialBody.setGravityScale(3f);
                MaterialBody.setAngularDamping(3f);
...
//                MaterialBody.setGravityScale(3f);
                ...
                MaterialBody.setUserData(materialSprite);
                MaterialBody.setAngularDamping(3f);
//                MaterialBody.setGravityScale(5f);
                materialBodies.add(MaterialBody);
            }
...
//                    birds.remove(i);
            ...
            if(pigsBodies.isEmpty()){
                ...
                ((Game)Gdx.app.getApplicationListener()).setScreen(new WinScreen(game,Level_2.this,new Level_3(),points,2));
            }
