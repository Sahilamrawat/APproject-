...
//        createGround();
        ...
        settingsButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                ((Game)Gdx.app.getApplicationListener()).setScreen(new Pause(game, Level_3.this));
...
//                    birds.remove(i);
            ...
            if(pigsBodies.isEmpty()){
                ...
                ((Game)Gdx.app.getApplicationListener()).setScreen(new WinScreen(game,Level_3.this,null,points,3));
            }
